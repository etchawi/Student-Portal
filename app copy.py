...
class User(UserMixin, db.Model):
    ...
    department = db.Column(db.String(100), nullable=True)  # Added field
    phone_number = db.Column(db.String(20), nullable=True)  # Added field
...
def search_people():
    ...
    return render_template('search_people.html', form=form, users=results)
